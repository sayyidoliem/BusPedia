...
fun AddPostScreens(
    ...
    Scaffold(
        topBar = {
            TopAppBar(title = { Text(text = "Add new post") },
                navigationIcon = {
        ...
        Column(
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                ...
                Column(modifier = Modifier.align(Alignment.Center)) {
                    FloatingActionButton(modifier = Modifier.align(Alignment.CenterHorizontally),
                        onClick = { viewModel.showImageDialog() }) {
                        Icon(
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    value = KotprefLocalStorage.username,
                    onValueChange = { },
                    readOnly = true
                )
                Spacer(modifier = Modifier.padding(horizontal = 8.dp))
    ...
    when {
        viewModel.confirmationDialog.value -> {
            AlertDialog(
                ...
                text = { Text("Are you sure you want to post this?") },
                dismissButton = {
                    TextButton(
                        onClick = {
                            viewModel.hideConfirmationDialog()
        ...
        viewModel.dateDialog.value -> {
            DatePickerDialog(
                onDismissRequest = { viewModel.hideDateDialog() },
                confirmButton = {
                    Button(
                        onClick = { viewModel.hideDateDialog() }
                    ) {
                        Text(text = "Confirm")
                    }
                },
        ...
        viewModel.imageDialog.value -> {
            Dialog(onDismissRequest = { viewModel.hideImageDialog() }) {
                Surface(
                    ...
                    Box(
                        ...
                        Column(modifier = Modifier.padding(20.dp)) {
                            ...
                            TextField(
                                ...
                                placeholder = { Text(text = "https://place/your/image.jpg") },
